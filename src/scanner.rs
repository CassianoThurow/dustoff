...
pub fn scan() -> Result<Vec<CleanupItem>> {
    ...
    let mut items = vec![
        ...
        directory_item(
            "npx-cache",
            "npx cache",
            "Temporary packages installed by npx",
            home.join(".npm/_npx"),
            Risk::Low,
        ),
        command_item(
            "pnpm-store",
            "pnpm store",
            "Unreferenced packages from the pnpm store",
            "pnpm",
            &["store", "prune"],
            Risk::Low,
        ),
        ...
        directory_item(
            ...
            "Downloaded Rust crate archives",
        ...
        directory_item(
            "cargo-git",
            "Cargo Git cache",
            "Git dependencies cached by Cargo",
        ...
        directory_item(
            "thumbnails",
            "Thumbnail cache",
            "Desktop-generated image thumbnails",
        ...
        directory_item(
            "trash",
            "User trash",
            "Files currently in the desktop trash",
        ...
        command_item(
            ...
            "Volumes unused by any container; may contain data",
            "docker",
            &["volume", "prune", "--force"],
            Risk::High,
        ),
